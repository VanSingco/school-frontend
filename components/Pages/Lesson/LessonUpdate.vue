    ...
    <NuxtLayout :name="accessType">
        ...
        <AlertErrorSuccess  
            ...
            <PageLoading :pageLoading="pageLoading" :pageError="pageError" title="Lesson Not Found" :link="`/${accessType}/lessons`">
                <form action="" method="post" @submit.prevent="updateLesson">
                    <div class="grid grid-col-1">
                        <div class="shadow sm:overflow-hidden sm:rounded-md w-full">
                            <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                <FormInput :models="models" :forms="lesson.getForms" />
                            </div>
...
<script setup lang="ts">
    ...
    const header = {
        ...
        breadcrumbs: [
            ...
            {name: 'Edit Lesson', link: '#'}
        ]
    };

    const lesson = useLessonStore();
    const {models} = storeToRefs(lesson);
    ...
    function updateLesson() {
        ...
        lesson.update(props.id, models.value).then(res => {
            errors.value = [];
            success.value = '';
            loading.value = false;
            ...
            if (res.error.value) {
                ...
                success.value = 'Successfully updated lessons';
            }
        });
    }
            ...
            lesson.show(props.id).then(res => {
                ...
                if (data && Object.keys(data).length > 0) {
                    ...
                    models.value = {
                        ...
                        assign_subject_schedule_id: data.assign_subject_schedule_id,
